...
public class PcapTestRL {
	...
	public class MyThread extends Thread{
		...
		public void run() {
			// TODO Auto-generated method stub
			while (true) {
				if(System.currentTimeMillis()-lastFinTime>10000) {
												...
												if (tcpPacket.getHeader().getSequenceNumberAsLong()+tcpPacket.getPayload().length()+1514*4>hashMap_contentLength
													...
													//	hashMap_length_time.put(time, content_length);
														...
														if(count_ack>3) {
															...
															System.out.println("判断速度为: "+speedComputer());
														...
														*/
														...
														if(count_ack>2) {
															try {
																...
																fw.write(count_ack+"  "+user.getqLevel()+"  "+(stoptime-stoptimeOld)+"  "+bufferAck+"  "+user.getFrom()+"  "+user.getBwLevel()+"\n");
																fw.close();
															} catch (IOException e) {
																// TODO Auto-generated catch block
																e.printStackTrace();
